        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Kind Add</h5>
                    </button>
                </div>
                <form name="frmMain" method="post" action="kind_add.php" target="iframe_target">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="kind_id" required class="form-control" id="recipient-name" placeholder="Please complete 3 characters.">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="kind_name" required class="form-control" id="recipient-name" placeholder="Kind Name">
                        </div>
                    </div>
            ...
            <div class="modal-content">
                ...
                <form name="frmMain" method="post" action="kind_edit.php" target="iframe_target">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="recipient-name" class="col-form-label">Kind ID:</label>
                            <input type="text" disabled name="kind_id" id="kind_id" required class="form-control"
                                id="recipient-name" placeholder="Please complete 4 characters.">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="kind_name" id="kind_name" required class="form-control"
                                id="recipient-name" placeholder="Kind Name.">
