                ...
                <form name="frmMain" method="post" action="type_add.php" target="iframe_target">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="type_id" required class="form-control" id="recipient-name" placeholder="Please complete 4 characters." minlength="4" maxlenght="4">
                        </div>
                        <div class="form-group">
                            <label for="recipient-name" class="col-form-label">Type Name:</label>
                            <input type="text" name="type_name" required class="form-control" id="recipient-name" placeholder="Type Name">
                        </div>
                    </div>
            ...
            <div class="modal-content">
                ...
                <form name="frmMain" method="post" action="type_edit.php" target="iframe_target">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="recipient-name" class="col-form-label">Type ID:</label>
                            <input type="text" disabled name="type_id" id="type_id" required class="form-control" id="recipient-name">
