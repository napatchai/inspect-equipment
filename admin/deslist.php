                ...
                <form name="frmMain" method="post" action="des_add.php" target="iframe_target">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="des_id" required class="form-control" id="recipient-name" placeholder="Please complete 4 characters.">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="des_name" required class="form-control" id="recipient-name" placeholder="Description Name">
                        </div>
                    </div>
            ...
            <div class="modal-content">
                ...
                <form name="frmMain" method="post" action="des_edit.php" target="iframe_target">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="recipient-name" class="col-form-label">Description ID:</label>
                            <input type="text" disabled name="des_id" id="des_id" required class="form-control" id="recipient-name">
