...
class QR_BarCode{
    ...
    for($x = 1 ; $x <= $qty; $x++){
        ...
        $dura_id = $money_id . '-' . $agency_id . '-' . $type_id . '-' . $category_id . $kind_id . $des_id . '/' . $p . $year . '-' . $x1;
        ...
        category_id = '$category_id', kind_id = '$kind_id', dura_year = '$year', IVZ_FSNum = '', money_id = '$money_id', des_id = '$des_id', code_year = '$date_id', dura_qr ='$qrcode1' ";
