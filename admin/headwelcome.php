            ...
            <form name="frmMain" method="post" action="profile_edit.php" target="iframe_target">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="username" value="<?php echo $_SESSION['per_username'] ?>" required
                            class="form-control" id="recipient-name">
                        <input type="hidden" name="username1" value="<?php echo $_SESSION['per_username'] ?>" required
                            class="form-control" id="recipient-name">
                        <input type="hidden" name="per_id" value="<?php echo $_SESSION['per_id'] ?>" required
                            class="form-control" id="recipient-name">
                    </div>
                    <div class="form-group">
                        <label for="recipient-name" class="col-form-label">First Name:</label>
                        <input type="text" name="Fname" value="<?php echo $_SESSION['per_firstname'] ?>" required
                            class="form-control" id="recipient-name">
                    </div>
                    <div class="form-group">
                        <label for="recipient-name" class="col-form-label">Last Name:</label>
                        <input type="text" name="Lname" value="<?php echo $_SESSION['per_lastname'] ?>" required
                            class="form-control" id="recipient-name">
                    </div>
                </div>
            ...
            <form name="frmMain" method="post" action="edit_password.php" target="iframe_target">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="hidden" name="per_id" value="<?php echo $_SESSION['per_id'] ?>" required
                            class="form-control" id="recipient-name">
                        <input type="hidden" name="old_pass" value="<?php echo $_SESSION['per_password'] ?>" required
                            class="form-control" id="recipient-name">
                    </div>
                    <div class="form-group">
                        <label for="recipient-name" class="col-form-label">New Password:</label>
                        <input type="password" name="new_password" id="new_pass" required class="form-control"
                            id="recipient-name">
                    </div>
                    <div class="form-group">
                        <label for="recipient-name" class="col-form-label">confirm Password:</label>
                        <input type="password" name="con_password" id="con_pass" required class="form-control"
                            id="recipient-name">
                    </div>
                </div>
                <div class="modal-footer">
...
<div class="row" style="z-index: -1;">
    ...
    <div class="col-sm-1" style="text-align: center;margin-top: 9px">
        <a href="#" class="edit-personnel" data-toggle="modal" data-target="#exampleModal15" data-whatever="@mdo">
            <i class="far fa-edit"></i>
        </a>
        <br>
        <a href="#" class="edit-personnel" data-toggle="modal" data-target="#exampleModal16" data-whatever="@mdo">
