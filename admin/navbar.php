<?php
    if($_SESSION['per_level'] != 'a' || $_SESSION["per_status"] == 1){
        ...
        <ul class="menu1">
            <form action="./search.php" method="post" id="formsearch">
                <div class="search search1">
                    <input type="text" id="inputsearch" name="search" placeholder="Search" class="inputsearch">
                    <a href="#" onclick="next()"><i class="fas fa-search se"></i></a>
                    <!-- <button><i class="fas fa-search se"></i></button> -->
                </div>
            </form>
            <li class="menu ca" style="color: #d4d4d4;">-</li>
            <li><a href="../scan.php" class="menu">Evaluation</a></li>
            <li><a href="manage.php" class="menu">Manage</a></li>
