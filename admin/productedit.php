...
<body>
    ...
    <?php include('./headwelcome.php'); 
           ...
           $ki = $row['kind_id'];
           $ki_name = $row['kind_name'];
           $de1 = $row['des_id'];
           $dename = $row['des_name'];
           $da1 = $row['dura_date'];
           $yda1 = substr($da1, 0,4) - 543;
           $dm1 = substr($da1, 4,9);
           $dura_use = $row['dura_use'];
           $relda1 = $yda1 . $dm1;
           $uni1 = $row['unit_id'];
           $ca1 =$row['dura_cost'];
           $co1 = $row['code_year'];
            ...
            <div class="inputaddproduct col-sm-8">
                <form name="frmMain" action="productedit_db.php" method="POST" target="iframe_target">
                    ...
                    <div class="row">
                        ...
                        ?>
                            Money :
                            <select name="money_id" disabled id="money_id" required class="inputadd">
                            ...
                            <input type="hidden" name="money_id" value="<?php echo $mon1 ?>">
                        </div>
                        <div class="col-sm-5">
                            <?php 
                            ...
                            ?>
                            Agency :
                            <select name="agency_id" disabled id="agency_id" required class="inputadd" style="padding: 5px">
                            ...
                            <input type="hidden" name="agency_id" value="<?php echo $agen1 ?>">
                            <input type="hidden" name="dura_id_old" value="<?php echo $_GET['id'] ?>">
                        </div>
                        <br><br><br>
                        <div class="col-sm-4">
                            <?php  
                        ...
                        ?>
                            Type :
                            <select name="type_id" disabled id="type_id" required class="inputadd">
                            ...
                            <input type="hidden" name="type_id" value="<?php echo $ty1 ?>">
                        ...
                        ?>
                            Category :
                            <select id="country" disabled name="category_id" required class="inputadd" id="recipient-name">
                            ...
                            <input type="hidden" name="category_id" value="<?php echo $cate1 ?>">
                        </div>

                        <div class="col-sm-4" style="margin-top: 10px">
                            Kind :
                            <select id="state" disabled name="kind_id" required class="inputadd" id="recipient-name">
                                <!-- <option value="">Select Category first</option> -->
                                <option value="<?php echo $ki ?>"><?php echo $ki . ' ' . $ki_name  ?></option>
                            </select>
                            <input type="hidden" name="kind_id" value="<?php echo $ki ?>">
                        </div>
                        <script>
                        ...
                        <div class="col-sm-4" style="margin-top: 20px">
                            Description :
                            <select id="city" name="des_id" disabled required class="inputadd" id="recipient-name">
                                <!-- <option value="">Select Category first</option> -->
                                <option value="<?php echo $de1 ?> "><?php echo $de1 . ' ' . $dename ?></option>
                            </select>
                            <input type="hidden" name="des_id" value="<?php echo $de1 ?>">
                        </div>
                        ...
                        <div class="col-sm-4" style="margin-top: 20px">
                            Used Fixed :
                            <br>
                            <input type="text" name="use" class="inputadd1" value="<?php echo $dura_use ?>" style="padding: 5px">
                        </div>
                        <br><br><br><br>
                        <div class="col-sm-3">
                            Date Recived
                        ...
                        <div class="col-sm-3" style="margin-top: 25px;">
                            <div class="row">
                                ...
                                <div class="col-sm-2">
                                    <input type="button" value="back" onclick="goback()" class="buttonback">
                                </div>
                            </div>
                        </div>
                    </div>
