                ...
                <form name="frmMain" method="post" action="category_add.php" target="iframe_target">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="category_id" required class="form-control" id="recipient-name">
                        </div>
                        <div class="form-group">
                            <label for="recipient-name" class="col-form-label">Category ID:</label>
                            <select name="category_id" id="category" require class="form-control" id="recipient-name">
                                ...
                                <option value="<?php echo $row['category_id'];?>">
                                    <?php echo $row['category_id'] . ' ' . $row['category_name'];?></option>
                                <?php    } ?>
                                ?>
                            </select>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="category_name" required class="form-control" id="recipient-name">
                        </div>
                    </div>
            ...
            <div class="modal-content">
                ...
                <form name="frmMain" method="post" action="category_edit.php" target="iframe_target">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="recipient-name" class="col-form-label">Category ID:</label>
                            <input type="text" name="category_id" id="category_id" required class="form-control"
                                id="recipient-name">
                        ...
                        <div class="list">
                            <div class="row">
                                ...
                                <div class="col-md-7 col-sm-6">
                                    <span class="textunit"><?php echo $row['des_id'] ?></span><br><br>
                                    <?php echo $row['des_name'] ?>
                                </div>
                                <div class="col-md-2 col-sm-3" style="z-index: -1">
