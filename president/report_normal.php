...
<body>
    ...
    include('./navbar.php'); 
    include('../condb.php');
    $top = "SELECT *, COUNT(dura_id) as dura_cu FROM durable as d INNER JOIN agency as a ON d.agency_id = a.agency_id WHERE dura_status = '1' GROUP BY d.agency_id ORDER BY COUNT(dura_id) DESC  LIMIT 5";
    ...
    <div class="container">
        <div class="col-sm-12 miss">
            ...
            <div class="textall">
                <span class="texton">Report Normal</span><br><span class="textunder">รายงานครุภัณฑ์ที่ปกติ</span></div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-sm-12 col-md-6">
                <span class="texton">Top 5 most Normal</span>
                <table class="table">
                    <thead>
                        <tr>
                            <th scope="col">ID</th>
                    ...
                    $agency_id = $row['agency_id'];
                        ...
                        <tr>
                            ...
                            <?php } ?>
                            <td style="text-align: center;"เ><a href="report_agency.php?agency=<?php echo $row['agency_id'] ?>&status=1" class="textclick">Click</a>
                            </td>
                        </tr>
            ...
            <div class="col-sm-12 col-md-11">
                <table class="table  table-sm" style="text-align: center;">
                    ...
                    <tbody>
                    <?php 
                        $sql = "SELECT * FROM durable as d INNER JOIN agency as a ON d.agency_id = a.agency_id INNER JOIN unit AS u ON d.unit_id = u.unit_id WHERE d.dura_status = 1 ";
