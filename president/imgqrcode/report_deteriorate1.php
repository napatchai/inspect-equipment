        ...
        <div class="row">
                ...
                <table class="table">
                    ...
                    $agency_id = $row['agency_id'];
                        ...
                        <tr>
                            ...
                            <?php } ?>
                            <td style="text-align: center;"เ><a href="report_agency.php?agency=<?php echo $row['agency_id'] ?>&status=5" class="textclick">Click</a>
                            </td>
                        </tr>
            ...
            <div class="col-sm-12 col-md-11">
                <table class="table  table-sm" style="text-align: center;">
                    ...
                    <tbody>
                    <?php 
                        $sql = "SELECT * FROM durable as d INNER JOIN agency as a ON d.agency_id = a.agency_id INNER JOIN unit AS u ON d.unit_id = u.unit_id WHERE d.dura_status = 5 ";
