    ...
    <div class="">
        <div class="col-sm-12 miss noprint">
            ...
            <div class="textall noprint">
                <span class="texton">Annual Report</span><br><span class="textunder">รายงานครุภัณฑ์ประจำปี</span></div><br>
                <form action="#" method="post">
                <div class="row">
                    <div class="col-sm-2">
                    <select name="codeyear" id="" required class="inputadd1 noprint">
                        ...
                        ?>
                            <option value="<?php echo $rowyear['eva_year'] ?>">-- <?php echo $rowyear['eva_year'] ?> --</option>
                        <?php } ?>
                    </select>
                    </div>
                    <div class="col-sm-2">
                    <select name="agency" id="" required class="inputadd1 noprint">
                        ...
                        ?>
                            <option value="<?php echo $rowagen['agency_id'] ?>">-- <?php echo $rowagen['agency_id'] . ' ' . $rowagen['agency_name'] ?> --</option>
                        <?php } ?>
                    </select>
                    </div>
                    <div class="col-sm-2">
                    <select name="money" id="" required class="inputadd1 noprint">
                        ...
                        ?>
                            <option value="<?php echo $rowmoney['money_id'] ?>">-- <?php echo $rowmoney['money_id'] . ' ' . $rowmoney['money_name'] ?> --</option>
                        <?php } ?>
                    </select>
                    </div>
                    <div class="col-sm-2">
                    <select name="type" id="" required class="inputadd1 noprint">
                        ...
                        ?>
                            <option value="<?php echo $rowtype['type_id'] ?>">-- <?php echo $rowtype['type_id'] . ' ' . $rowtype['type_name'] ?> --</option>
                        <?php } ?>
                    </select>
                    </div>
                    <div class="col-sm-1">
                    ...
                    <div class="col-sm-2">
                        ...
                        <a href="#" onClick="window.print();" style="margin-top: 100px;font-size: 25px" media="buttonsubmit" class="noprint"  ><i class="fas fa-print"></i></a>
                    </div>
                </div>
                ...
                <table class="table  table-sm" style="text-align: center;">
                    ...
                    ?>
                        ...
                        <tr>
                            ...
                            <td><a style="color: #8E8E8E;text-decoration: none;" href="#" title="กลุ่มสินทรัพย์ถาวร" data-toggle="popover"
                                    data-placement="right" data-trigger="focus"
                                    data-content="<?php echo $row2['type_name'] ?>"><?php echo $row2['type_id'] ?></a>
                            </td>
                            <td><a target="_blank" style="color: #8E8E8E;text-decoration: none;" href="report_see_dura.php?id=<?php echo $row2['dura_id'] ?>"><?php echo $row2['dura_id'] ?></a></td>
